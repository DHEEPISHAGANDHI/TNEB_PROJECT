...
if(isset($_POST['signup'])){
   ...
   //  $password=md5($password);
    ...
    //  $checkEmail="SELECT * From users where email='$email'";
     ...
     $SELECT1 = "SELECT * From user_registration Where phone = '$phone'";
     ...
     if($result1->num_rows>0){
        ...
        $insertQuery="INSERT INTO  user_registration (username ,email ,phone ,state ,district ,area ,password ,confirmpassword)
