...
if ($adminResult->num_rows > 0) {
    ...
    $query = "SELECT * FROM user_registration WHERE state = '$adminState' AND district = '$adminDistrict' AND area = '$adminArea'";
...
<body>
    ...
    <div class="container">
        ...
        if (isset($result) && $result->num_rows > 0) {
            ...
            echo "<p>No users found matching your state, district, and area.</p>";
        }
        ?>
    </div>
</body>
